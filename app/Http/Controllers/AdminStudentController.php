...
class AdminStudentController extends Controller // <--- PERUBAHAN NAMA CLASS
{
    ...
    public function destroy($id)
    {
        ...
        // Hapus User (Otomatis menghapus Student karena cascade di database biasanya)
        $user->delete(); 
