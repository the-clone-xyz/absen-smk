...
const scrollLeft = () => {
    if (classContainer.value) {
        classContainer.value.scrollBy({ left: -320, behavior: "smooth" });
    }
};
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
                <div class="xl:col-span-2 space-y-8">
                    <div class="relative group/slider">
                        <h3
                            class="font-bold text-xl text-slate-800 flex items-center gap-2 mb-4"
                        >
                            <span
                        ...
                        <div class="relative">
                            <button
                                v-if="kelas.length > 0"
                                @click="scrollLeft"
                                class="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 z-20 bg-white p-2 rounded-full shadow-lg border border-slate-100 text-slate-500 hover:text-indigo-600 hover:scale-110 transition-all hidden md:flex items-center justify-center"
                            >
                            ...
                            <div
                                ref="classContainer"
                                class="flex gap-4 overflow-x-auto pb-6 pt-1 px-1 snap-x snap-mandatory scrollbar-hide -mx-1 scroll-smooth"
                                style="
                            ...
                            <button
                                v-if="kelas.length > 0"
                                @click="scrollRight"
                                class="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 z-20 bg-white p-2 rounded-full shadow-lg border border-slate-100 text-slate-500 hover:text-indigo-600 hover:scale-110 transition-all hidden md:flex items-center justify-center"
                            >
